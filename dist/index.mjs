...
var users_router_exports = {};
__export(users_router_exports, {
  default: () => users_router_default
});
import { Router } from "express";
var router, users_router_default;
...
app.use("/api", (init_users_router(), __toCommonJS(users_router_exports)).default);
var app_default = app;
